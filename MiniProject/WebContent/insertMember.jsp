...
<script language="JavaScript">
    ...
    function openConfirmid(userinput) {
        ...
        url = "memberConfirmId.jsp?id=" + userinput.id.value ;
...
<form method="post" action="insertMemberPro.jsp" name="userinput" onSubmit="return checkIt()">
  <table width="600" border="1" cellspacing="0" cellpadding="3" align="center" >
    ...
    <tr> 
      ...
      <td width="400"> 
        <input type="text" name="phoneNumber" size="15" maxlength="15"> "-"를 빼고 입력해주세요.
      </td>
    </tr>
    <tr> 
    <tr> 
